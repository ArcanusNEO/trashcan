...
alias mkddir='mkdir Applications Comics Desktop Documents Downloads Games Library Movies Music Pictures Projects Public Resources Templates Temporary Videos'
alias sudo='sudo '
